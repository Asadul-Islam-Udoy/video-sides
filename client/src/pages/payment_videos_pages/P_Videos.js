...
import './P_Videos.css';
import Sidebar from '../../component/payment_videos/sidbar/Sidebar';
import Bodys from '../../component/payment_videos/bodys/Bodys';
import { useState } from 'react';
import Navbar from '../../component/payment_videos/navbar/Navbar';
import {useDispatch,useSelector} from 'react-redux';
import {useAlert} from 'react-alert';
import { getAllPaymentVideosAction} from '../../action/VideosAction';
...
function P_Videos() {
    ...
    dispatch(getAllPaymentVideosAction(keyword,paginationbar));
